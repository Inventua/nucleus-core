...
/// Singleton system event handlers are used when an event is raised in a scheduled task, or in other cases where there 
/// isn't a current HttpContext.
/// Implementations of ISingletonSystemEventHandler handle a single model type and event type represented by <typeparamref name="TEvent"/> and <typeparamref name="TModel"/>.
/// </remarks>
public interface ISingletonSystemEventHandler<TModel, TEvent> : ISystemEventHandler<TModel, TEvent>
{
