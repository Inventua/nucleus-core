...
namespace Nucleus.ViewFeatures.HtmlHelpers
{
	...
	public static class PageListHtmlHelper
	{
		...
		public static IHtmlContent PageListFor<TModel, Guid>(this IHtmlHelper<TModel> htmlHelper, Expression<Func<TModel, Guid>> expression, Nucleus.Abstractions.Models.PageMenu pageMenu)
		{
			...
			return Nucleus.ViewFeatures.HtmlContent.PageList.Build(htmlHelper.ViewContext, htmlHelper.IdFor(expression), htmlHelper.NameFor(expression), selectedPage, null, pageMenu, "(none)", null).Result;
		}
		...
		{		
			...
			return Nucleus.ViewFeatures.HtmlContent.PageList.Build(htmlHelper.ViewContext, htmlHelper.IdFor(expression), htmlHelper.NameFor(expression), selectedPage, disabledPageId, pageMenu, "(none)", null).Result;
		}
		...
		public static IHtmlContent PageListFor<TModel, Guid>(this IHtmlHelper<TModel> htmlHelper, Expression<Func<TModel, Guid>> expression, Nucleus.Abstractions.Models.PageMenu pageMenu, System.Guid disabledPageId, object htmlAttributes)
		{
			...
			return Nucleus.ViewFeatures.HtmlContent.PageList.Build(htmlHelper.ViewContext, htmlHelper.IdFor(expression), htmlHelper.NameFor(expression), selectedPage, disabledPageId, pageMenu, "(none)", htmlAttributes).Result;
		}
		...
		/// <param name="pageMenu"></param>
		/// <param name="disabledPageId"></param>
		/// <param name="noSelectionText"></param>
		/// <param name="htmlAttributes"></param>
		/// <typeparam name="TModel"></typeparam>
		/// <typeparam name="Guid"></typeparam>
		/// <returns></returns>
		...
		/// page and controller.  It will not work standalone.
		/// </remarks>
		public static IHtmlContent PageListFor<TModel, Guid>(this IHtmlHelper<TModel> htmlHelper, Expression<Func<TModel, Guid>> expression, Nucleus.Abstractions.Models.PageMenu pageMenu, System.Guid disabledPageId, string noSelectionText, object htmlAttributes)
		{
			ModelExpressionProvider provider = htmlHelper.ViewContext.HttpContext.RequestServices.GetService<ModelExpressionProvider>();
			ModelExpression modelExpression = provider.CreateModelExpression(htmlHelper.ViewData, expression);
			System.Guid selectedPage = modelExpression.Model == null ? System.Guid.Empty : (System.Guid)modelExpression.Model;

			return Nucleus.ViewFeatures.HtmlContent.PageList.Build(htmlHelper.ViewContext, htmlHelper.IdFor(expression), htmlHelper.NameFor(expression), selectedPage, disabledPageId, pageMenu, noSelectionText, htmlAttributes).Result;
		}
	}
}
