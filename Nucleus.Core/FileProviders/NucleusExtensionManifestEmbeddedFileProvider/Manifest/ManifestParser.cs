...
// This is a copy from https://github.com/dotnet/aspnetcore/blob/main/src/FileProviders/Embedded/src/ with a change to the Parse()
// method (line 67) to create a manifest document tree with an "Extensions" root, and a child representing the specified extension
// name, which contains a Children() collection which consists of the embedded resources top level.  
using System;
...
internal static class ManifestParser
{
  ...
  public static EmbeddedFilesManifest Parse(Assembly assembly, string extensionName)
  {
    return Parse(assembly, extensionName, DefaultManifestName);
  }

  public static EmbeddedFilesManifest Parse(Assembly assembly, string extensionName, string name)
  {
    ...
    var extensionDirectory = ManifestDirectory.CreateDirectory(extensionName, entriesList.ToArray());
