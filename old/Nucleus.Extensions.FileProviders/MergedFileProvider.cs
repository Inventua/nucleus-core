...
//	/// <br/><br/>
//	/// The Merged File Provider service is injected by the OsaAppCore host and is always available in all OsaAppCore applications.  
//	/// </remarks>
...
//			if (subpath.IndexOf("/merged.") >= 0 && this.Context.HttpContext.Request.Query.ContainsKey("src"))
//			{
...
//		private Boolean TryProvider(IFileProvider provider, string path, Stream stream)
//		{
//			StreamReader reader;
