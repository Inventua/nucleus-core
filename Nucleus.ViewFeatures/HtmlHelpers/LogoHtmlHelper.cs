...
namespace Nucleus.ViewFeatures.HtmlHelpers
{
	...
	public static class LogoHtmlHelper
	{
		...
		{
			return Nucleus.ViewFeatures.HtmlContent.Logo.Build(htmlHelper.ViewContext, "", htmlAttributes).Result;
		}
		...
		{
			return Nucleus.ViewFeatures.HtmlContent.Logo.Build(htmlHelper.ViewContext, caption, htmlAttributes).Result;
		}
	}
}
