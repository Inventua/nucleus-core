...
/// <summary>
/// Extensions used to check the a user's permissions.
/// </summary>
public static class PermissionExtensions
{
  ...
  /// </remarks>
  public static Boolean HasEditPermission(this System.Security.Claims.ClaimsPrincipal user, Site site, ControlPanelExtensionDefinition controlPanelExtension, Type controllerType)
  {
        ...
        if (!String.IsNullOrEmpty(authAttribute.Policy))
        {
          ...
          switch (authAttribute.Policy)
          {
            ...
            case Nucleus.Abstractions.Authorization.Constants.SITE_ADMIN_POLICY:
              if (site == null || !user.IsSiteAdmin(site)) return false;
              break;
          }
        }
      }
