// ----------------------------------------------------------
// Stylesheet and script merging has been removed.  While merging static resource content did yield a first-time performance improvement, 
// potential problems outweigh the benefits:
// - Changes to AddScriptHtmlHelper in 1.4 control the order that scripts are rendered, and merging scripts can break the correct ordering
//   of scripts.
// - Merging scripts and styles on pages with various combinations of scripts/styles generates different browser cache entries, so leaving them
//   un-merged it is more likely for the browser to have already cached the required resource.
// - Merging scripts and styles is a non-standard practise, can break dynamic resource loading, and does not work with embedded resources.
// ----------------------------------------------------------
//using System;
//using System.Linq;
...
//						{
//							path = String.Join(System.IO.Path.AltDirectorySeparatorChar, pathParts.Skip(1)); 
