...
namespace $nucleus_extension_namespace$.Controllers
{
	...
	public class $nucleus_extension_name$AdminController : Controller
	{
		...
		public $nucleus_extension_name$AdminController(Context Context, PageModuleManager pageModuleManager, $nucleus_extension_name$Manager $nucleus_extension_name_lcase$Manager)
		{
