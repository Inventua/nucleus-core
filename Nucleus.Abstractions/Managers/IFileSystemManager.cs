...
public interface IFileSystemManager
{
  ...
  public Task<Nucleus.Abstractions.Models.Paging.PagedResult<File>> Search(Site site, string searchTerm, IEnumerable<Role> userRoles, Nucleus.Abstractions.Models.Paging.PagingSettings pagingSettings);
}
