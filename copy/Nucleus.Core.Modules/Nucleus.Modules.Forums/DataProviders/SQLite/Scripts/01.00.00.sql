...
(
	...
	UNIQUE([Name]),
	PRIMARY KEY([Id]),
	FOREIGN KEY([ForumGroupId]) REFERENCES ForumGroups([Id]) ON DELETE CASCADE
);
GO
...
(
	...
	FOREIGN KEY([StatusListId]) REFERENCES Lists([Id]) ON DELETE SET NULL
);
GO
...
(
	...
	[ChangedBy] GUID NULL,
	PRIMARY KEY([Id]),
	FOREIGN KEY([StatusId]) REFERENCES ListItems([Id]) ON DELETE SET NULL
);
GO
...
(
	...
	PRIMARY KEY([Id]),
	FOREIGN KEY([ForumPostId]) REFERENCES ForumPosts([Id]) ON DELETE CASCADE,
	FOREIGN KEY([ForumReplyId]) REFERENCES ForumReplies([Id]) ON DELETE CASCADE
);
GO
