...
namespace Nucleus.Modules.Forums.Controllers
{
	...
	public class ForumsController : Controller
	{
		...
		private async Task<ViewModels.ViewForumPost> BuildPostViewModel(ViewModels.ViewForumPost viewModel, Boolean readReplies)
		{
			...
			viewModel.CanDeletePost = viewModel.Forum.EffectiveSettings().Enabled && this.ForumsManager.CheckPermission(this.Context.Site, HttpContext.User, viewModel.Forum, ForumsManager.PermissionScopes.FORUM_DELETE_POST);
