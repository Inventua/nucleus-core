...
namespace Nucleus.Core.Managers
{
  ...
  public class ScheduledTaskManager : IScheduledTaskManager
  {
    ...
    {
      // the task scheduler runs operations in parallel, and thus can call SaveHistory/TruncateHistory in parallel.  We have to serialize calls to
      // SaveScheduledTaskHistory and TruncateScheduledTaskHistory so that entity framework does not throw exceptions as a result of trying to save a
      // new history twice "at once" and having one fail and/or update a history record that has been deleted by TruncateHistory.
