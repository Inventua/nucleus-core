...
//	/// <br/><br/>
//	/// The Minified File Provider service is injected by the OsaAppCore host and is always available in all OsaAppCore applications.  The 
...
//		public MinifiedFileProvider(MinifiedFileProviderOptions options, ILogger<MinifiedFileProvider> Logger, params IFileProvider[] fileProviders)
//		{
//			this.Options = options;
//			this.Logger = Logger;
//			this.FileProviders = fileProviders ?? new IFileProvider[0];
...
//		private MemoryStream MinifyJs(string code)
//		{
//			MemoryStream result = new MemoryStream();
//			StreamWriter writer = new StreamWriter(result);

//			NUglify.JavaScript.CodeSettings settings = new NUglify.JavaScript.CodeSettings
//			{
//				MinifyCode = true
//			};
...
//		private MemoryStream MinifyCss(string code)
//		{
//			MemoryStream result = new MemoryStream();
//			StreamWriter writer = new StreamWriter(result);

//			NUglify.Css.CssSettings settings = new NUglify.Css.CssSettings();
...
//		{
//			return Folders.GetDataFolder("Cache\\MinifiedFileProvider");
//		}
