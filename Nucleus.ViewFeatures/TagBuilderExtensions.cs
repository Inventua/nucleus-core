...
namespace Nucleus.ViewFeatures
{
	...
	public static class TagBuilderExtensions
	{
		...
		/// <returns></returns>
		public static IDictionary<string, object> GetAttributes(object htmlAttributes)
		{
		...
		/// <returns></returns>
		public static object GetAttribute(object htmlAttributes, string key)
		{
			if (GetAttributes(htmlAttributes).TryGetValue(key, out object value))
			{
				return value;
			}
			return null;
