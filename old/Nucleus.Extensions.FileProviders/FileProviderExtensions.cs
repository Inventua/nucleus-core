...
//using Nucleus.Extensions.Plugins;
...
//	/// </summary>
//	/// <remarks>
//	/// File providers are added by OsaAppCore.Host.  You would not typically need to use these function in an OsaAppCore application.
//	/// </remarks>
...
//			{
//				MergedFileProvider objMergedFileProvider = new MergedFileProvider(this.Options, options, this.ContextAccessor, this.Logger);
...
//				foreach (string assemblyFileName in AssemblyLoader.GetAssembliesWithAttribute<Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute>(this.Environment.ContentRootPath))
//				{
...
//					Assembly assembly = AssemblyLoader.LoadFrom(assemblyFileName.Replace(".Views", ""));
//					string folder;

//					if (assemblyFileName.Contains(this.Environment.ContentRootPath + "\\Apps"))
//					{
//						folder = assemblyFileName.Replace(this.Environment.ContentRootPath + "\\Apps", "");
...
//					//Util.StartupLogger.LogInformation($"Adding embedded files from {assembly.FullName}.");
