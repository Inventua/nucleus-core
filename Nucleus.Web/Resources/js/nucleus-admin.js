...
function _handleContentLoaded(e, args)
{
  ...
  // If the new content contains any forms which which do not have a data-target attribute or the data-target is an empty string, set the data-target to form.parent().  This
  ...
  var forms = args.target.find('form');
