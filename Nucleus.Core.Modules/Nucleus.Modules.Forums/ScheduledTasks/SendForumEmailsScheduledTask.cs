...
//{
//	public abstract class SendForumEmailsScheduledTask : IScheduledTask
//	{
...
//    private NotificationFrequency NotificationFrequency { get; }
...
//		public SendForumEmailsScheduledTask(NotificationFrequency notificationFrequency, ForumsManager forumsManager, IUserManager userManager, ISiteManager siteManager, IPageManager pageManager, IPageModuleManager pageModuleManager, IMailClientFactory mailClientFactory, IMailTemplateManager mailTemplateManager, ILogger<SendForumEmailsScheduledTask> logger)
//		{
...
//			this.Logger.LogInformation("Sending forum messages ({frequency}).", this.NotificationFrequency);

//			var queue = (await this.ForumsManager.ListMailQueue(this.NotificationFrequency))
