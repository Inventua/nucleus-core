...
//		public MergeStylesheetsTagHelper(IUrlHelper urlHelper, IOptions<MergedFileProviderOptions> options, ILogger<MergeStylesheetsTagHelper> Logger)
//		{
...
//					linkbuilder.Attributes.Add("href", this.UrlHelper.Content($"~/{linkpath}/merged.css?src={linksUrl}{this.Version()}"));
