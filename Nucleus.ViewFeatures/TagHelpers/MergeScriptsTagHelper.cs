...
//		public MergeScriptsTagHelper(IUrlHelper urlHelper, IOptions<MergedFileProviderOptions> options, ILogger<MergeScriptsTagHelper> Logger)
//		{
...
//				builder.Attributes.Add("src", this.UrlHelper.Content($"~/merged.js?src={scriptUrl}{this.Version()}"));
