...
public class ScheduledTasksController : Controller
{
  ...
  public ScheduledTasksController(ILogger<ScheduledTasksController> logger, IOptions<TextFileLoggerOptions> options, IScheduledTaskManager scheduledTaskManager, RunningTaskQueue queue)
  {
    this.Logger = logger;
