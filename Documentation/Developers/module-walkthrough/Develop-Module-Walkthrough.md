...
Nucleus Extension are .Net Core ASP.NET MVC projects which use a [controller](https://docs.microsoft.com/en-us/aspnet/core/tutorials/first-mvc-app/adding-controller) class which contains
...
Review the DbContext class, and add code to the [OnModelCreating](https://docs.microsoft.com/en-us/dotnet/api/system.data.entity.dbcontext.onmodelcreating) function to tell 
Entity Framework about your database objects.
