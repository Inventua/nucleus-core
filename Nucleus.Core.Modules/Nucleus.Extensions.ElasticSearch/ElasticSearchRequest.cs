  ...
  private IHighlight BuildHighlighter()
  {
    return new Highlight()
    {
      ...
      Fields = new Dictionary<Field, IHighlightField>()
        {
          { ParseField(nameof(ElasticSearchDocument.Summary)), new HighlightField() { RequireFieldMatch = false, NumberOfFragments=0 } },
          { ParseField(nameof(ElasticSearchDocument.Title)), new HighlightField() { RequireFieldMatch = false, NumberOfFragments=0 } },
          { ParseField(nameof(ElasticSearchDocument.Content)), new HighlightField() { RequireFieldMatch = false, NumberOfFragments=0 } }
        }
    };
  }
