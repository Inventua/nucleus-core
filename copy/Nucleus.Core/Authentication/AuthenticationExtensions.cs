...
namespace Nucleus.Core.Authentication
{
	public static class AuthenticationExtensions
	{
		...
		public static IServiceCollection AddCoreAuthentication(this IServiceCollection services, IConfiguration configuration)
		{
			...
			services.AddAuthentication(Nucleus.Core.Authentication.AuthenticationHandler.DEFAULT_AUTH_SCHEME)
				.AddScheme<Nucleus.Core.Authentication.AuthenticationOptions, Nucleus.Core.Authentication.AuthenticationHandler>(Nucleus.Core.Authentication.AuthenticationHandler.DEFAULT_AUTH_SCHEME, options =>
				{	});
