...
public static class RoutingConstants
{
  ...
  /// </summary>
  public const string ADMIN_ROUTE_PATH_PREFIX = "admin";

  /// <summary>
  /// Root path for the Api route.
  /// </summary>
  public const string API_ROUTE_PATH_PREFIX = "api";

  /// <summary>
  /// Root path for file requests.
  /// </summary>
  public const string FILES_ROUTE_PATH_PREFIX = "files";

  /// <summary>
  /// Root path for the extensions route.
  /// </summary>
  public const string EXTENSIONS_ROUTE_PATH_PREFIX = "extensions";
  ...
  /// <summary>
  /// Api route path pattern
  /// </summary>
  public const string API_ROUTE_PATH = $"/{RoutingConstants.API_ROUTE_PATH_PREFIX}/{{extension:exists}}/{{controller}}/{{action=Index}}/{{mid?}}/{{id?}}";

  /// <summary>
  /// Extension controllers path pattern
  /// </summary>
  public const string EXTENSIONS_ROUTE_PATH = $"/{RoutingConstants.EXTENSIONS_ROUTE_PATH_PREFIX}/{{extension:exists}}/{{controller}}/{{action=Index}}/{{mid?}}/{{id?}}";

  /// <summary>
  /// Area path pattern
  /// </summary>
  public const string AREA_ROUTE_PATH = "/{area}/{controller}/{action=Index}/{id?}";
