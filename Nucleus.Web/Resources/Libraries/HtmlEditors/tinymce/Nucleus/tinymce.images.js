tinymce.util.Tools.resolve("tinymce.PluginManager").add("images", function (editor, url)
{
	...
	{
		var url = document.baseURI + 'User/FileSelector/Index?pattern=(.gif)|(.png)|(.jpg)|(.jpeg)|(.bmp)|(.webp)|(.svg)&showSelectAnother=false&applicationAbsoluteUrl=false&noFilesMessage=(no image files)&showImagePreview=true';
		jQuery.ajax({
      url: url,
      async: true,
			method: 'GET',
